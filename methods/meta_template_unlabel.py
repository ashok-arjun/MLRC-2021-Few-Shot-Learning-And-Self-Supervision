    ...
    def __init__(self, model_func, n_way, n_support, change_way = True):
        ...
        if isinstance(model_func,str):
            if model_func == 'resnet18':
                self.feature = ResidualNet('ImageNet', 18, 1000, None)
            elif model_func == 'resnet18_cbam':
                self.feature = ResidualNet('ImageNet', 18, 1000, 'CBAM')
            elif model_func == 'resnet18_dualcbam':
                self.feature = ResidualNet('ImageNet', 18, 1000, 'CBAM', dual_cbam=True)
                self.dual_cbam = True
