...
class ProtoNet(MetaTemplate):
        ...
        for i, inputs in enumerate(train_loader):
            ...
            if (i+1) % print_freq==0:
                ...
                if self.jigsaw:
                    ...
                    print('Epoch {:d} | Batch {:d}/{:d} | Loss Rotation {:f}'.\
                        format(epoch, i+1, len(train_loader), avg_loss_rotation/float(i+1)))
    ...
    def test_loop(self, test_loader, record = None):
        ...
        for i, inputs in enumerate(test_loader):
            ...
            if self.jigsaw:
                ...
                correct_this_rotation, count_this_rotation = self.correct(x, inputs[2], inputs[3])
            else:
    ...
    def set_forward(self,x,is_feature = False, patches=None, patches_label=None):
    ...
    def set_forward_loss(self, x, patches=None, patches_label=None):
