...
class ProtoNet(MetaTemplate):
    def __init__(self, model_func,  n_way, n_support, jigsaw=False, lbda=0.0, rotation=False, tracking=False, lbda_jigsaw=0.0, lbda_rotation=0.0):
        super(ProtoNet, self).__init__( model_func,  n_way, n_support, tracking=tracking)
