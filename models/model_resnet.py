...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers,  network_type, num_classes, att_type=None, tracking=True, use_bn=True):
        ...
        # self.layer1 = MyModule(self.layer1)
        # self.layer2 = MyModule(self.layer2)
        # self.layer3 = MyModule(self.layer3)
        # self.layer4 = MyModule(self.layer4)
